...
<section class="users">
   ...
   <h1 class="title">Tài khoản quản trị viên</h1>

   <div class="box-container">
      <div class="box">
         <p>Đăng ký quản trị viên mới</p>
         <a href="register_admin.php"  class="delete-btn" style="background-color:burlywood ;">Đăng ký quản trị viên</a>
      </div>
      <?php
      $type = 'admin';
         $select_users = mysqli_query($conn, "SELECT * FROM `users` WHERE user_type = '$type'") or die('query failed');
      ...
      <div class="box">
         ...
         <a href="admin_update_profile.php?update=<?php echo $fetch_users['id']; ?>"  class="delete-btn">Cập nhật quản trị viên</a>
      </div>
      <?php
         }
      }
